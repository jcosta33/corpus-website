...
export function HexBadge({
  ...
  return (
    <div
      className={`relative flex h-14 w-14 shrink-0 items-center justify-center clip-hex bg-panel-raised shadow-[inset_0_1px_0_rgba(255,255,255,0.14),inset_0_-3px_4px_rgba(0,0,0,0.45)] ${signalRoles[role].text} ${className}`}
    >
